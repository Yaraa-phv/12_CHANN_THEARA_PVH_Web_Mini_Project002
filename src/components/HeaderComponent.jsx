...
export default function HeaderComponent({ user, workspaces }) {
  return (
    <>
      {/* Top navigation bar */}
      <div className="border-b border-gray-200 px-4 py-2 flex items-center justify-between">
        <div className="flex items-center space-x-2">
          ...
          <a  className="text-sm text-blue-500 font-medium">
            Name
          </a>
        </div>
        ...
        <div className="flex items-center space-x-4">
          ...
          <div key={user.payload.userId} className="flex items-center">
            <img src={`${user.payload.profile}`} className="h-8 w-8 rounded-full text-white flex items-center justify-center mr-2" alt="User Profile" />
      ...
      {/* Title section with workspace name */}
